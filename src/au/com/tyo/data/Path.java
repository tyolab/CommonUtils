...
public class Path<ObjectType, ChildType> {
    private static final String TAG = "Path";
    private static Path sRoot = new Path(null, "ROOT");

    private final Path mParent;
    private final String mSegment;
    private WeakReference<ObjectType> mObject;
    private ChildType mChildren;
...
//            if (mChildren == null) {
//                mChildren = Class.forName(className);
//            } else {
...
//        }
    ...
    public void setObject(ObjectType object) {
        synchronized (Path.class) {
            mObject = new WeakReference<ObjectType>(object);
        }
    }
